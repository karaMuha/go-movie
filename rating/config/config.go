...
func NewConfig() *Config {
	...
	flag.StringVar(&config.Port, "port", ":8081", "Listen for requests on this port")
	...
	flag.StringVar(&config.DbPort, "db_port", "5433", "Database port")
	...
	flag.StringVar(&config.DbName, "db_name", "ratings_db", "Database name")
